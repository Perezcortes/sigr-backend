...
import { IsEmail, IsString, MinLength, IsOptional, IsNumberString, Matches } from "class-validator";
...
export class ResetPasswordDto {
  ...
  @Matches(passwordValidationRegex, { message: "La contraseña debe contener al menos una mayúscula, un número y un carácter especial." })
  new_password: string;
}
